...
[![GitHub Repo](https://img.shields.io/badge/Repository-Step__semester__3-181717?style=for-the-badge&logo=github)](https://github.com/ak4746/Step_semester_3)
...
### Week 6: Object-Oriented Programming (OOP) Fundamentals

#### 🔹 Live-Coding Problems (`WEEK-6/`)
| Problem | File | Key Concepts |
| :--- | :--- | :--- |
| **Student Record** | [`Student.java`](./WEEK-6/Student.java) | Class design, constructor initialization, profile display |
| **Course Management** | [`Course.java`](./WEEK-6/Course.java) | Course enrollment, capacity validation, seat tracking |
| **Student ID Card** | [`IdCard.java`](./WEEK-6/IdCard.java) | ID card issuance, identity formatting |
| **Mess Wallet** | [`MessWallet.java`](./WEEK-6/MessWallet.java) | Encapsulation, top-up/deduct transactions, balance protection |
| **Placement Record** | [`PlacementRecord.java`](./WEEK-6/PlacementRecord.java) | Placement eligibility, company offer tracking |

#### 🔹 Assignment Solutions (`Week-6-Assignments/`)
| Problem | File | Key Concepts |
| :--- | :--- | :--- |
| **M1. Library Inventory Management** | [`BookInventory.java`](./Week-6-Assignments/BookInventory.java) | Object state encapsulation, array of objects, instance methods |
| **M2. Payroll Salary Management** | [`PayrollAccount.java`](./Week-6-Assignments/PayrollAccount.java) | Private fields, validation guards, bonus credits, tax deduction |
| **M3. Employee Profile Creation** | [`EmployeeProfile.java`](./Week-6-Assignments/EmployeeProfile.java) | Constructor overloading, constructor chaining with `this(...)` |
| **M4. Exam Hall Ticket Reference** | [`HallTicket.java`](./Week-6-Assignments/HallTicket.java) | Reference semantics, shallow alias modification vs. separate instance equality |
| **M5. Employee & Company Info** | [`CompanyEmployee.java`](./Week-6-Assignments/CompanyEmployee.java) | Static fields (`companyName`, `employeeCount`), static utility methods |
